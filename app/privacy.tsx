  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <Section title="אילו נתונים נאספים">
        ...
        בפעילות באפליקציה (הדרכות, חידונים, סרטונים) נשמרות נקודות וסטטיסטיקות
      ...
      <Section title="שירותי צד שלישי">
        ...
        ההדרכות, ובוויקיפדיה למידע על אתרים - בהתאם למדיניות הפרטיות של כל
        שירות בהתאמה.
      </Section>
...
const styles = StyleSheet.create({
  ...
  updated: { fontSize: 12, color: theme.colors.textMuted, marginTop: 4, marginBottom: theme.spacing(2) },
